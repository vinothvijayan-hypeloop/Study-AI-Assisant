...
// ========================================================================
//  FIX #1: Import BOTH `saveStudyHistory` and `updateStudyHistory`
// ========================================================================
...
const PdfPageNavigator = ({ 
  ...
  const [studyHistoryId, setStudyHistoryId] = useState<string | null>(null);
  ...
  const saveConsolidatedHistory = async () => {
    ...
    try {
      ...
      if (studyHistoryId) {
        // ========================================================================
        //  FIX #2: Call `updateStudyHistory` with the `analysisResult` object directly
        // ========================================================================
        await updateStudyHistory(studyHistoryId, analysisResult);
      } else {
        // Create new record (This part was already correct)
